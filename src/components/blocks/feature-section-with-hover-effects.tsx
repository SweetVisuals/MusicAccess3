...
export function FeaturesSectionWithHoverEffects() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative z-10 py-10 w-full px-4">
...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r border-t py-10 relative group/feature dark:border-neutral-800",
