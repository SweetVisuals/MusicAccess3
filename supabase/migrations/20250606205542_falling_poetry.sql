/*
  # Create get_profile_with_stats RPC function

  1. New Functions
    - `get_profile_with_stats(profile_id uuid)`
      - Returns profile data with stats in a single call
      - Maps database columns to frontend expected format
      - Handles the name/full_name mapping issue
